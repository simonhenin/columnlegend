...
location = 'NorthEast';
boxon = false; legend_h = []; padding = 0;
...
height      = ydata1(1) + (ydata1(1)-ydata2(1))*padding;                    % height of the box. Used to top margin offset
...
% height      = (height/numlines)*numpercolumn;
col = -1;
for i=1:numlines,
